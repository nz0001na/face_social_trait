...
for n in range(len(list)):
    ...
    for r in t:
        ...
        right_wrist.append([float(r.split(',')[3]), float(r.split(',')[4].split('\n')[0])])
    ...
    for i in range(1, len(shoulder_distance)):
        ...
        left_wrist_move = left_distance / shoulder_distance[i]
        ...
        right_wrist_move = right_distance / shoulder_distance[i]

        movements.append([str(i), str(shoulder_distance[i]), str(left_distance), str(left_wrist_move), str(right_distance), str(right_wrist_move)])
